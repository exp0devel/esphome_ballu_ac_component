...
ballu_ac_FIRMWARE_VERSION = '0.2.17'
...
AirCon = ballu_ac_ns.class_("AirCon", climate.Climate, cg.Component)
Capabilities = ballu_ac_ns.namespace("Constants")

# Display actions
AirConDisplayOffAction = ballu_ac_ns.class_("AirConDisplayOffAction", automation.Action)
AirConDisplayOnAction = ballu_ac_ns.class_("AirConDisplayOnAction", automation.Action)

# test packet action
AirConSendTestPacketAction = ballu_ac_ns.class_(
    "AirConSendTestPacketAction", automation.Action
)

# vertical louvers actions
AirConVLouverSwingAction = ballu_ac_ns.class_(
    "AirConVLouverSwingAction", automation.Action
)
AirConVLouverStopAction = ballu_ac_ns.class_("AirConVLouverStopAction", automation.Action)
AirConVLouverTopAction = ballu_ac_ns.class_("AirConVLouverTopAction", automation.Action)
AirConVLouverMiddleAboveAction = ballu_ac_ns.class_(
    "AirConVLouverMiddleAboveAction", automation.Action
)
AirConVLouverMiddleAction = ballu_ac_ns.class_(
    "AirConVLouverMiddleAction", automation.Action
)
AirConVLouverMiddleBelowAction = ballu_ac_ns.class_(
    "AirConVLouverMiddleBelowAction", automation.Action
)
AirConVLouverBottomAction = ballu_ac_ns.class_(
    "AirConVLouverBottomAction", automation.Action
)
AirConVLouverSetAction = ballu_ac_ns.class_(
    "AirConVLouverSetAction", automation.Action
)

# power limitation actions
AirConPowerLimitationOffAction = ballu_ac_ns.class_(
    "AirConPowerLimitationOffAction", automation.Action
)
AirConPowerLimitationOnAction = ballu_ac_ns.class_(
...
def output_info(config):
    _LOGGER.info("ballu_ac firmware version: %s", ballu_ac_FIRMWARE_VERSION)
    return config
...
async def to_code(config):
    CORE.add_define(
        Define("ballu_ac_FIRMWARE_VERSION", '"'+ballu_ac_FIRMWARE_VERSION+'"')
    )
    CORE.add_define(
        Define("ballu_ac_PACKET_TIMEOUT_MIN", AC_PACKET_TIMEOUT_MIN)
    )
    CORE.add_define(
        Define("ballu_ac_PACKET_TIMEOUT_MAX", AC_PACKET_TIMEOUT_MAX)
    )
    CORE.add_define(
        Define("ballu_ac_MIN_INVERTER_POWER_LIMIT", AC_POWER_LIMIT_MIN)
    )
    CORE.add_define(
        Define("ballu_ac_MAX_INVERTER_POWER_LIMIT", AC_POWER_LIMIT_MAX)
    )
...
@automation.register_action(
    "ballu_ac.display_off", AirConDisplayOffAction, DISPLAY_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.display_on", AirConDisplayOnAction, DISPLAY_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_stop", AirConVLouverStopAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_swing", AirConVLouverSwingAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_top", AirConVLouverTopAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_middle_above", AirConVLouverMiddleAboveAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_middle", AirConVLouverMiddleAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_middle_below", AirConVLouverMiddleBelowAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_bottom", AirConVLouverBottomAction, VLOUVER_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.vlouver_set", AirConVLouverSetAction, VLOUVER_SET_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.power_limit_off", AirConPowerLimitationOffAction, POWER_LIMITATION_OFF_ACTION_SCHEMA
)
...
@automation.register_action(
    "ballu_ac.power_limit_on", AirConPowerLimitationOnAction, POWER_LIMITATION_ON_ACTION_SCHEMA
)
...
# Вызывайте метод ballu_ac.send_packet только если понимаете, что делаете! Он не проверяет данные, а передаёт
...
@automation.register_action(
    "ballu_ac.send_packet", AirConSendTestPacketAction, SEND_TEST_PACKET_ACTION_SCHEMA
)
